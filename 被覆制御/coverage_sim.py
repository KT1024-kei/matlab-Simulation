...
def main():
    ...
    # ゲインによっては最適解に収束しない例
    pnts = np.array([[ 0.92443447, 0.03348763],
                        [ 0.10310365, 0.48130787],
                        [ 0.8496255,  0.73822855],
                        [ 0.92097061, 0.8442517 ],
                        [ 0.3573504,  0.87688482],
                        [ 0.80697816, 0.18329306],
                        [ 0.73391,    0.78892882],
                        [ 0.5560772,  0.2405105 ],
                        [ 0.68398991, 0.0300374 ]])
    print(pnts)
    # 計算回数
    time = range(400)
